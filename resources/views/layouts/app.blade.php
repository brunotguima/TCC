        ...
        <div id="app">
            <header class="page-header">
                <nav class="nav-wrapper">
                    <div class='row'>
                        <div class="col s3"><a href="/" class="brand-logo">{{ config('app.name', 'Logo WhyBuy') }}</a></div>
                        ...
                        <div class="col s5 right-align">
                            @if (Auth::guest())
                            <a class='dropdown-button btn' href='#' data-activates='dropdown1'>Login ou Cadastro</a>
                            ...
                            @else
                            <a class='dropdown-button btn' href='#' data-activates='dropdown1'>Olá {{ Auth::user()->name }}!</a>
                            <ul id='dropdown1' class='dropdown-content'>
                                <li><a href="">
                                        Painel de Controle
                                    </a></li>
